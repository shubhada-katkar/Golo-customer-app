...
export default function DeleteAccountModal({
    ...
    const handlePerformDeletion = async () => {
        ...
        try {
            ...
            // Call DELETE /users/account with fallback to /merchant/account if needed
            let response = await fetch(`${BASE_URL}/users/account`, {
                method: "DELETE",
                headers: {
            ...
            if (response.status === 404) {
                response = await fetch(`${BASE_URL}/merchant/account`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            if (onShowAlert) {
                onShowAlert("Deletion Failed", errorText, "error");
            }
        } finally {
            setIsDeleting(false);
        }
                        ...
                        <View style={styles.stepContainer}>
                            ...
                            <View style={styles.warningBox}>
                                <Text style={styles.warningText}>
                                    Deleting your account will permanently remove your profile, favorites, reviews, and activity history. This information will no longer be available.
                                </Text>
                            </View>
                        ...
                        <View style={styles.stepContainer}>
                            ...
                            <View style={styles.finalWarningBox}>
                                <Text style={styles.finalWarningText}>
                                    This action is permanent and cannot be reversed. Your account, profile, favorites, reviews, and activity data will be permanently deleted immediately.
                                </Text>
                            </View>
                    ...
                    {step === 4 && (
                        <View style={styles.stepContainer}>
                            ...
                            <Text style={styles.successMessageText}>
                                Your account and all associated data have been successfully and permanently removed.
                            </Text>
