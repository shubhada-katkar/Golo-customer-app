...
export default function Login({ navigation }) {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      return () => subscription.remove(); // ✅ new API
    }, [forgotMode])
  );
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        await AsyncStorage.multiRemove(["customerToken", "customerData", "customerId"]);
      ...
      // Token validation
      if (!data.token || !data.customer || !data.customer._id) {
      ...
      await AsyncStorage.multiSet([
        ...
        ["customerData", JSON.stringify(data.customer)],
          ...
          {!forgotMode ? (
            ...
            <>
              ...
              <View style={styles.inputpassword}>
                <TextInput style={{ fontSize: 14, flex: 1, fontFamily: "Medium" }}
            ...
            <>
              ...
              {!otpSent ? (
                <TouchableOpacity
                  ...
                  <Text style={{ color: "white", fontSize: 16, fontFamily: "Medium", lineHeight: Math.round(16 * 1.6) }}>
                    {otpLoading
                      ? "Sending..."
                      : otpCooldown > 0
                        ? `Sent ✓ (${otpCooldown}s)`
        ...
        {!forgotMode ? (
          <>
            ...
            <View style={{ alignItems: "center", flexDirection: "row" }}>
              <Text style={{ fontSize: 16, fontFamily: "Medium" }}>Forgot Password?</Text>
